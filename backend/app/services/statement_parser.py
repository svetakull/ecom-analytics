...
CLASSIFICATION_RULES = [
    ...
    (r"(?i)интернет.?технологии|ООО.*интернет.*технолог", "income_ozon", 0.95),  # поступление от Ozon
    ...
    (r"(?i)оплата.*за.*оказани.*услуг.*пвз|услуги.*пвз", "income_pvz", 0.9),  # поступление от ПВЗ
