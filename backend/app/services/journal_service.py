...
DDS_CATEGORIES = sorted([
    ...
    {"key": "pvz", "name": "Расходы ПВЗ (прочее)", "section": "expenses"},
    {"key": "pvz_tko", "name": "ТБО", "section": "expenses"},
    {"key": "pvz_internet", "name": "Интернет (ПВЗ)", "section": "expenses"},
    {"key": "pvz_video", "name": "Видеонаблюдение (ПВЗ)", "section": "expenses"},
